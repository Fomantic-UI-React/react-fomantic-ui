...
const itAppliesDefaultProps = (value) => {
  it('applies defaultProps', () => {
    ...
    expect(getShorthand({ value, defaultProps }).props).toEqual(defaultProps)
  })
}
...
const itDoesNotIncludePropsFromMapValueToProps = (value) => {
  it('does not include props from mapValueToProps', () => {
    ...
    const wrapper = getShorthand({ value, mapValueToProps: () => props })
...
const itMergesClassNames = (classNameSource, extraClassName, shorthandConfig) => {
  it(`merges defaultProps className and ${classNameSource} className`, () => {
    ...
    expect(getShorthand({ defaultProps, overrideProps, ...shorthandConfig }).props.className).toBe(
...
const itAppliesProps = (propsSource, expectedProps, shorthandConfig) => {
  it(`applies props from the ${propsSource} props`, () => {
    expect(getShorthand(shorthandConfig).props).toEqual(expectedProps)
  })
}
...
const itOverridesDefaultProps = (propsSource, defaultProps, expectedProps, shorthandConfig) => {
  it(`overrides defaultProps with ${propsSource} props`, () => {
    expect(getShorthand({ defaultProps, ...shorthandConfig }).props).toEqual(expectedProps)
  })
}
...
describe('factories', () => {
  describe('createShorthandFactory', () => {
    it('is a function', () => {
      expect(createShorthandFactory).toBeTypeOf('function')
    })
  ...
  describe('createShorthand', () => {
    it('is a function', () => {
      expect(createShorthand).toBeTypeOf('function')
    })
    ...
    describe('defaultProps', () => {
      it('can be an object', () => {
        ...
        expect(getShorthand({ value: 'foo', defaultProps }).props).toEqual(defaultProps)
      })
    })
    ...
    describe('childKey', () => {
      ...
      it('is called with the final `props` if it is a function', () => {
        const props = { foo: 'bar', childKey: vi.fn(({ foo }) => foo) }
    ...
    describe('overrideProps', () => {
      it('can be an object', () => {
        ...
        expect(getShorthand({ value: 'foo', overrideProps }).props).toEqual(overrideProps)
      })
      ...
      it("is called with the user's element's and default props", () => {
        ...
        getShorthand({ defaultProps, overrideProps, value })
    ...
    describe('from a props object', () => {
      ...
      describe('children', () => {
        ...
        it('receives overrideProps in its props argument', () => {
          ...
          expect(children).toHaveBeenCalledWith('p', { ...overrideProps, children: undefined })
        })
      })
    })
    ...
    describe('style', () => {
      it('merges style prop', () => {
        ...
        expect(
          getShorthand({ defaultProps, overrideProps, value: userProps }).props.style,
      ...
      it('merges style prop and handles override by userProps', () => {
        ...
        expect(getShorthand({ defaultProps, value: userProps }).props.style).toEqual({
          left: 10,
          bottom: 10,
        })
      })
      ...
      it('merges style prop and handles override by overrideProps', () => {
        ...
        expect(getShorthand({ overrideProps, value: userProps }).props.style).toEqual({
          bottom: 10,
          right: 10,
        })
      })
      ...
      it('merges style prop from defaultProps and overrideProps', () => {
        ...
        expect(getShorthand({ defaultProps, overrideProps, value: 'foo' }).props.style).toEqual({
          left: 10,
          bottom: 10,
        })
      })
